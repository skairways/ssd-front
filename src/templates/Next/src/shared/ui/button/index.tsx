...
const getSizeClasses = (size: UIButtonProps['size']) => {
    switch (size) {
        case 'small': {
            return 'px-4 py-2.5';
        }
...
const getModeClasses = (isPrimary: UIButtonProps['primary']) =>
    isPrimary
 ...
 * Primary UI component for user interaction
 */
export const UIButton = ({ primary = false, size = 'medium', label, ...props }: UIButtonProps) => {
